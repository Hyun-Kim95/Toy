...
<script>
	DiaryUserModify__submited = false;
	function DiaryUserModify__checkAndSubmit(form) {
		if (DiaryUserModify__submited) {
			alert('처리중입니다.');
			return;
		}
		...
		DiaryUserModify__submited = true;
		form.submit();
	}
</script>
...
<section class="section-1">
	<div class="bg-white shadow-md rounded container mx-auto p-8 mt-8">
		<form onsubmit="DiaryUserModify__checkAndSubmit(this); return false;"
			...
			<c:if test="${diaryUser.id == loginedDiaryUserId}">
				<div class="form-row flex flex-col lg:flex-row">
					<div class="lg:flex lg:items-center lg:w-28 font-bold">
						<span>로그인비번</span>
					</div>
			...
			<div class="form-row flex flex-col lg:flex-row">
				...
				<div class="lg:flex-grow">
					<input value="${diaryUser.name}" type="text" name="name" autofocus="autofocus"
			...
			<div class="form-row flex flex-col lg:flex-row">
				...
				<div class="lg:flex-grow">
					<input value="${diaryUser.nickname}" type="text" name="nickname" autofocus="autofocus"
			...
			<div class="form-row flex flex-col lg:flex-row">
				...
				<div class="lg:flex-grow">
					<input value="${diaryUser.email}" type="email" name="email" autofocus="autofocus"
			...
			<div class="form-row flex flex-col lg:flex-row">
				...
				<div class="lg:flex-grow">
					<input value="${diaryUser.cellphoneNo}" type="text" name="cellphoneNo" autofocus="autofocus"
